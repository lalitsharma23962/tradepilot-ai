...
export function AnalyticsPage() {
  ...
  return <div className="space-y-6 p-6">
    ...
    <Card><CardHeader title="Historical Validation Lab" subtitle="20,000 Binance candles → fees + slippage → strict 10R/15R production targets → three non-overlapping pre-OOS stability folds → untouched 30% OOS → Monte Carlo" action={<Button onClick={runValidation} disabled={running}>{running?`Validating… ${elapsed}s`:'Run validation'}</Button>}/><CardBody className="space-y-4">
