...
export function AnalyticsPage() {
  ...
  const [timeframe, setTimeframe] = useState<ValidationInterval>('15m');
  ...
  const runValidation = async () => {
    ...
    try {
      ...
      const res=await api.validationApi('BTCUSDT',timeframe,{initialCapital:10000,feeBps:Number(account?.fee_bps??10),slippageBps:Number(account?.slippage_bps??2),maxPositionPct,leverage,riskPerTradePct});
